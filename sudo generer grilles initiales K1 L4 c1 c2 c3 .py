...
def menu():
    ...
    print("   g  : pour générer K1 L4 c1 c2 c3")
    ct=0
...
def générer():    # modifiée : pour générer une -grille initiale-
    numpb[0]=0 #init nom
    ...
    #choix_1_carré2() # remplit carré 1  , le 1er choix pour carré2 et les suivants...

    choix_lig4_col1() # 1er choix ligne 4 (+ choix 2 et choix 3)
    

    print("nb de grilles ",indice[0])
...
def choix_4_carré2():  # indice = 3   complète 4e cellule du carré et suivantes   
    # attribuer une valeur dans la 4e cellule (cel3)
    ...
    for i_cell4 in range(nb_poss_cel4):
        ...
        #print(grille)
        #print("...")
        #choix_1_col7()  #fin provisoire
        
# ....................................................
def choix_5_carré2():  # indice = 4 complète la 5e cellule du carré et les suivantes 
    
    # choix successifs pour cellule 4 du K2 (en 2,5 l=1,c=4, indice 4 (cel4) [01234...]
    # init choix
    lig=1 ; col=4 #; indice=4
    nb_poss=0
    i2=0
...
def choix_6_carré2():
    ...
    #initjeu()
    #grille[1,5]=0 # init pour suivant
...
def choix_7_carré2(): # choix 7, 8 et 9
    ...
    #    for c in range(3):
    #        if grille[l,c+3]>0:
    #            print(int(grille[l,c+3]),end="")
    #print("   faire suite cellule 7 et suivantes   ",tabpos[21])
    grille[2,3]=0
    initjeu()
    # choix multiples
    lig=2 ; col=3 
    ...
    for i_cell7 in range(nb_poss):
        ...
        for i in range(9):
            if tabpos[22,i]>0:
                ...
                npos=npos+1
        #print("npos,v1,v2",npos,v1,v2)
        #if npos>2:
        #    n=input()
        # restent 2 possibilités pour cellules 8 et 9 (v1 et v2)
        grille[2,4]=v1;grille[2,5]=v2
        #indice[0]=indice[0]+1
        #affiche_grille(grille)
        #for l in range(3):   # affiche choix dans K2
        #    for c in range(3):
        #        print(int(grille[l,c+3]),end="")
        #    print(end="  ")
        #indice[0]=indice[0]+1   
        #print(" >>> ",indice[0],"   faire suite col7 lig 1 +++",end="   ")
...
def choix_lig4_col1(): # 1er choix ligne 4
    
    #print();print("début choix_lig4_col1 : ",indice)
    grille[3,0]=0
    initjeu()
    lig=3 ; col=0
    nb_poss=0
    ...
    for i_lig4col1 in range(nb_poss):
        ...
        #indice[0]=indice[0]+1
        #print(grille[lig,col]);print(grille)
        initjeu()
        
        
        #affiche_grille(grille) lignes 1 à 3
        #print(grille)
        #for l in range(3):   # affiche choix dans K2
        #    for c in range(4):
        #        print(int(grille[l,c+3]),end="")
        #    print("  ",end="")
        #print(end=".")  #,"           faire suite")
...
def choix_lig4_col2(): # 2e choix ligne 4
    ...
    for i1 in range(9):
        ...
        if val>0:
            ...
            i2=i2+1
    #print()
    # pour visualiser le nb de possibles alternativement 6 ou 5
    #print(nb_poss," valeurs possibles en L4 c2")
    #print("valeur en 3,1 : ",int(grille[3,0])," ---> ",nb_poss," possibles en 3,2 ",tabpos[lig*9 +col])
...
def choix_lig4_col3(): # 3e choix ligne 4
    ...
    #print(indice);print("choix l4 c3")
    grille[3,2]=0
    initjeu()
    lig=3 ; col=2
    nb_poss=0
    ...
    for i1 in range(9):
        ...
        if val>0:
            ...
            choix_l4_c3[i2]=val
            i2=i2+1
    #print(lig+1,col+1,tabpos[lig*9 +col])
    #print(nb_poss," valeurs possibles en L4 c3")
    #print()
    # pour visualiser le nb de possibles 5 , 4 ou 6
    #print("valeur en 3,1 : ",int(grille[3,1])," ---> ",nb_poss," possibles en 3,2 ",tabpos[lig*9 +col])
    #print();print("choix L4 c3  (",nb_poss," possibles)",end="  ")
    ...
    for i_lig4col3 in range(nb_poss):
        ...
        #print(end=". ")
        # faire suite
        #print();print(nb_poss," choix_lig4_col4() puis nb de possibles en L4 c5 (pour choix_lig4_col5()):")

        #choix_lig4_col4()  ---------->> fin de choix ici

        indice[0]=indice[0]+1
        if indice[0]==1:
            print("1er choix");affiche_grille(grille)
        else :   
            print (indice,end="")
        if indice[0]==162:
            print();print("dernier choix");affiche_grille(grille)
        
        
        grille[3,2]=0 # init pour choix suivant
    #print(indice[0],end=" ")
    #print(" --kk-->   ",indice[0] -indice_ini, "valeurs possibles en L4 c5")
...
def choix_lig4_col4(): # 4e choix ligne 4
    ...
    # pour visualiser le nb de possibles 5 , 4 ou 6
    #print("valeur en 3,1 : ",int(grille[3,1])," ---> ",nb_poss," possibles en 3,2 ",tabpos[lig*9 +col])
    #print("choix L4 c4  " ,nb_poss,end=" ")
    #print(tabpos[lig*9 +col])
    ...
    #print();print(indice[0],end=" ")
        
    #n=input()
# ....................................................
choix_l4_c5=np.zeros(6)
def choix_lig4_col5(): # 4e choix ligne 4
    ...
    for i_lig4col5 in range(nb_poss):
        ...
        #indice[0]=indice[0]+1  #dddddddddddd
...
def choix_lig4_col6(): # 4e choix ligne 4
    print("choix_lig4_col6",indice)
    grille[3,5]=0
    initjeu()
    lig=3 ; col=5
    nb_poss=0
...
def choix_1_col7(): # 1er choix colonne 7
    ...
    #print(choix_c7_l1)
    print();print("c7_l2 :",nb_poss)
    #n=input()
    #print (tabpos[lig*9 +col])
    for i_col7lig1 in range(nb_poss):
        print("choix",i_col7lig1 +1,"/",nb_poss,"valeur ",choix_c7_l1[i_col7lig1])
...
def choix_2_col7(): # 2e choix colonne 7
    ...
    print();print("c7_l2 :",nb_poss,"possibles en 2,7 : ",tabpos[lig*9 +col])
    print();print(grille)
    for i_col7lig2 in range(nb_poss):
        ...
        #affiche_grille(grille) #lignes 1 à 4
        #for l in range(3):   # affiche choix dans K2
        #    for c in range(4):
        #        print(int(grille[l,c+3]),end="")
        #    print("  ",end="")
        #print(end=".")  #,"           faire suite c7 l3")
        
        choix_3_col7()
        print(indice,"c7_l3",end="")
...
def choix_3_col7(): # 3e choix colonne 7
    ...
    print();print("c7_l3 :",nb_poss,"possibles en 3,7 : ",tabpos[lig*9 +col])
    print();print(grille)
    
    for i_col7lig3 in range(nb_poss):
        print(i_col7lig3 +1,"/",nb_poss,end=" : ")
...
def choix_4_col7(): # 4e choix colonne 7
    ...
    for i_col7lig4 in range(nb_poss):
        print("  ",i_col7lig4 + 1,"/",nb_poss,end=" ")
        grille[lig,col]=choix_c7_l4[i_col7lig4]
        initjeu()
        #indice[0]=indice[0]+1
        
        
        # faire suite c7 l7 l8 et l9
...
def fin_grille_initiale(): # pour afficher et tester (ou non) la grille (ou son indice)
    MAJdd()      # fait pas apparaître les ereurs (VU en colonne 7 et ligne 4)

    if grilleVU[4,6] == 0:
        indice[0]=indice[0]+1 # grille initiale validée
        #print(end=".")
        
def suitt():        
        if indice[0]>160 :    #1140 :
            print()
            print(grille);print(grilleD);print(grilleVU)
            n=input()
        else :
            print(indice,end="")
