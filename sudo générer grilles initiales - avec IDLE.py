...
def générer_grille_initiale():    # modifiée : pour générer une -grille initiale-
...
def choix_7_carré2(): # choix 7, 8 et 9
    ...
    for i_cell7 in range(nb_poss):
        ...
        choix_lig4_col1()  # remplit la ligne 4 (puis la colonne 7)
        #n=input()
...
def choix_lig4_col6(): # 4e choix ligne 4
    ...
    for i_lig4col6 in range(nb_poss):
        ...
        #print("choix_1_col7() --->")
        #n=input()
        choix_1_col7()   # remplit la colonne 7
    ...
    if grilleVU[4,6] == 0:
        ...
        if indice[0] % 100 == 0 :
            ...
            if indice[0] % 500 == 0 :
                ...
                affiche_grille(grille)
    #else :
        #print("#",end="") # permet de visualiser les choix non retenu
        #affiche_grille(grille)
        #affiche_grille(grilleD) # visualise 3 doubles possible au lieu de 4
        
    # fin de l'écriture de la procédure "générer grille initiale" avec tests multiples
# ....................................................
def générer():    # génère une grille aléatoire
    numpb[0]=0
    for l in range(9):   # init
        for c in range(9):
            grille[l,c]=0 
    ct=0
        ...
        if ct >70 and ct<81 :
            ...
            for l in range(9):   
                for c in range(9):
                    if grille[l,c]>0:
                        ct=ct+1
        if ct>70 and ct==ct1 and ct< 81  : # pas de solution recommencer
            print(ct,end="/")
            for l in range(9):   
                for c in range(9):
                    grille[l,c]=0
...
def choix_aléatoire():    
    ...
    choi=0
    while choi==0:
        lig=random.randint(0, 8) # entier entre 0 et 8 inclus
